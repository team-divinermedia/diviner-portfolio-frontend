        ...
        <footer className="border-t border-slate-200 bg-gradient-to-r from-slate-900 via-slate-900 to-slate-950">
            <div className="mx-auto flex max-w-6xl flex-col gap-4 px-4 py-8 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
                    <a
                        href="https://wa.me/918347572000?text=Hey!%20I%20was%20exploring%20your%20live%20feed%20and%20I'm%20impressed.%20Can%20we%20talk%20about%20a%20project?"
                        target="_blank"
                        rel="noreferrer"
        ...
        <div className="fixed inset-0 z-[60] flex items-end justify-center sm:items-center sm:px-4">
            ...
            <div className="relative w-full max-w-md overflow-hidden rounded-t-[32px] border border-slate-800 bg-[#040817] p-6 text-center shadow-2xl shadow-black/50 sm:rounded-[32px] sm:p-8">
                ...
                <div className="flex flex-col gap-3">
                    <a
                        href="https://wa.me/918347572000?text=Hi%2C%20I%20saw%20your%20portfolio%20and%20I%27m%20interested%20in%20your%20services."
                        target="_blank"
                        rel="noreferrer"
